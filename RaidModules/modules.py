...
class RaidModules(commands.Cog):
    ...
    async def all_kick(self, ctx):
        await ctx.send(f"Quieres kickear a todos? `{ctx.guild.name}`? [y/n]")
    ...
    async def all_ban(self, ctx):
        await ctx.send(f"Quieres banear a todos `{ctx.guild.name}`? [y/n]")
    ...
    async def all_rename(self, ctx, newname):
        await ctx.send(f"Quieres renombrar a todos a `{newname}` in `{ctx.guild.name}`? [y/n]")
    ...
    async def all_dm(self, ctx, message):
        await ctx.send(f"DM a todos con `{message}` in `{ctx.guild.name}`? [y/n]")
    ...
    async def del_emojis(self, ctx):
        await ctx.send(f"Borrar todos los emojis `{ctx.guild.name}`? [y/n]")
    ...
    async def del_invites(self, ctx):
        await ctx.send(f"Borrar todas las invitaciones `{ctx.guild.name}`? [y/n]")
    ...
    async def del_channels(self, ctx):
        await ctx.send(f"Borrar todos los canales `{ctx.guild.name}`? [y/n]")
    ...
    async def del_roles(self, ctx):
        global wait
        await ctx.send(f"Quieres borrar todos los roles `{ctx.guild.name}`? [y/n]")
